...
export function AdminPropertiesPage() {
  ...
  const handleViewCollectionProperties = (
    collectionId: number,
  ...
  return (
    <div className="min-h-screen bg-cream pt-24 pb-12 px-6 md:px-12">
          ...
          <>
            ...
            {viewMode === "grid" && (
              <div className="space-y-8">
                ...
                >
                  {ADMIN_MOCK_PROPERTIES.map((property, index) => (
                    <motion.div
                      key={property.id}
                      initial={{
                        opacity: 0,
              ...
              {MOCK_COLLECTIONS.map((collection, index) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-charcoal/10">
                    ...
                    <button
                      onClick={() =>
                        handleViewCollectionProperties(
                          collection.id,
                          collection.name
                        )
                      }
      ...
      <AnimatePresence>
        {showStatusConfirmModal && statusChange && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            <motion.div
              initial={{
                opacity: 0,
