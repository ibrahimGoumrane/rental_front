      ...
      <div className="max-w-[1800px] mx-auto">
        ...
        >
          ...
          <div className="flex items-center space-x-3">
            <button
              onClick={() => setShowBlockedKeywordsModal(true)}
                      ...
                      <div className="max-w-xs">
                        <p className="text-sm text-charcoal">
                          {conversation.flaggedPortion ? (
                            <>
                              {
                                conversation.lastMessage.split(
                                  conversation.flaggedPortion
                                )[0]
                              }
        ...
        {showBlockedKeywordsModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            <motion.div
              ...
              onClick={() => setShowBlockedKeywordsModal(false)}
            />
            <motion.div
              initial={{
                opacity: 0,
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <select
                    value={exportFilters.flagReason}
                    onChange={(e) =>
                      setExportFilters({
                        ...exportFilters,
                        flagReason: e.target.value,
