...
import { Users, Home, Calendar, DollarSign, TrendingUp, TrendingDown, AlertCircle, Shield, Flag, MessageSquare, CheckCircle, Clock, Star, MapPin, CreditCard, Bell, FileText, Award, Activity, X } from 'lucide-react';
// Mock data
...
const RECENT_BOOKINGS = [{
  ...
  property: {
    ...
    image: 'https://images.unsplash.com/photo-1600596542815-2495db98dada?auto=format&fit=crop&q=80&w=200'
  },
  guest: {
    name: 'Sarah Jenkins',
  ...
  property: {
    ...
    image: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&q=80&w=200'
  },
  guest: {
    name: 'Michael Chen',
  ...
  property: {
    ...
    image: 'https://images.unsplash.com/photo-1503174971373-b1f69850bded?auto=format&fit=crop&q=80&w=200'
  },
  guest: {
    name: 'Emma Thompson',
...
export function AdminDashboardPage() {
  ...
  return <div className="min-h-screen bg-cream pt-24 pb-12 px-6 md:px-12">
      <div className="max-w-[1800px] mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
          ...
          <div className="xl:col-span-9 space-y-8">
            {/* KPI Cards */}
            <motion.div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" initial="hidden" animate="show" variants={{
            hidden: {
              opacity: 0
            },
            show: {
            ...
            }} onMouseEnter={() => setHoveredCard('users')} onMouseLeave={() => setHoveredCard(null)}>
                <Link to="/admin/users" className="block bg-sand rounded-2xl p-6 border border-charcoal/5 shadow-sm hover:shadow-xl transition-all relative overflow-hidden group cursor-pointer">
                  {hoveredCard === 'users' && <div className="absolute inset-0 bg-gold/10 pointer-events-none" />}
            ...
            }} onMouseEnter={() => setHoveredCard('properties')} onMouseLeave={() => setHoveredCard(null)}>
                <Link to="/admin/properties" className="block bg-sand rounded-2xl p-6 border border-charcoal/5 shadow-sm hover:shadow-xl transition-all relative overflow-hidden group cursor-pointer">
                  {hoveredCard === 'properties' && <div className="absolute inset-0 bg-gold/10 pointer-events-none" />}
                  <div className="flex items-start justify-between mb-4 relative z-10">
                    <div>
                      <p className="text-xs uppercase tracking-widest text-charcoal/60 font-medium mb-2">
                        Properties Listed
            ...
            }} onMouseEnter={() => setHoveredCard('reservations')} onMouseLeave={() => setHoveredCard(null)}>
                <Link to="/admin/reservations" className="block bg-sand rounded-2xl p-6 border border-charcoal/5 shadow-sm hover:shadow-xl transition-all relative overflow-hidden group cursor-pointer">
                  {hoveredCard === 'reservations' && <div className="absolute inset-0 bg-gold/10 pointer-events-none" />}
                  <div className="flex items-start justify-between mb-4 relative z-10">
                    <div>
                      <p className="text-xs uppercase tracking-widest text-charcoal/60 font-medium mb-2">
                        Active Reservations
            ...
            }} onMouseEnter={() => setHoveredCard('revenue')} onMouseLeave={() => setHoveredCard(null)}>
                <Link to="/admin/billing" className="block bg-sand rounded-2xl p-6 border border-charcoal/5 shadow-sm hover:shadow-xl transition-all relative overflow-hidden group cursor-pointer">
                  {hoveredCard === 'revenue' && <div className="absolute inset-0 bg-gold/10 pointer-events-none" />}
                  <div className="flex items-start justify-between mb-4 relative z-10">
                    <div>
                      <p className="text-xs uppercase tracking-widest text-charcoal/60 font-medium mb-2">
                        Monthly Revenue
            ...
            delay: 0.4
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Link to="/admin/users?verificationStatus=unverified" className="border border-charcoal/10 rounded-xl p-6 hover:border-warm-green/30 hover:shadow-lg transition-all relative group cursor-pointer">
                ...
                <Link to="/admin/properties?verificationStatus=unverified" className="border border-charcoal/10 rounded-xl p-6 hover:border-warm-green/30 hover:shadow-lg transition-all relative group cursor-pointer">
                  <div className="absolute top-4 right-4">
                    <div className="w-3 h-3 bg-terracotta rounded-full animate-pulse" />
                  </div>
                ...
                <Link to="/admin/messages" className="border border-charcoal/10 rounded-xl p-6 hover:border-terracotta/30 hover:shadow-lg transition-all group cursor-pointer">
              ...
              <div className="mt-6">
                <Link to="/admin/reports" className="block border border-charcoal/10 rounded-xl p-6 hover:border-terracotta/30 hover:shadow-lg transition-all group cursor-pointer">
            ...
            delay: 0.5
              ...
              <div className="bg-white rounded-2xl p-8 border border-charcoal/5 shadow-sm">
                ...
                <div className="space-y-4 max-h-[600px] overflow-y-auto">
                  {RECENT_BOOKINGS.map((booking, index) => <motion.div key={booking.id} initial={{
                  opacity: 0,
                  x: -20
                }} animate={{
                  opacity: 1,
                  ...
                  delay: 0.6 + index * 0.1
                      ...
                      <div className="flex items-start space-x-4">
                        <img src={booking.property.image} alt={booking.property.name} className="w-16 h-16 rounded-lg object-cover" />
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between mb-2">
                            ...
                            <span className={`px-2 py-1 rounded-full text-xs font-bold ${booking.status === 'confirmed' ? 'bg-warm-green text-white' : 'bg-gold text-white'}`}>
                              {booking.status}
                            </span>
                          </div>
                          <div className="flex items-center space-x-2 mb-2">
                            <img src={booking.guest.avatar} alt={booking.guest.name} className="w-6 h-6 rounded-full border-2 border-sand" />
              ...
              <div className="bg-white rounded-2xl p-8 border border-charcoal/5 shadow-sm">
                ...
                <div className="space-y-3 max-h-[600px] overflow-y-auto">
                  {PLATFORM_ACTIVITY.map((activity, index) => <motion.div key={activity.id} initial={{
                  opacity: 0,
                  x: 20
                }} animate={{
                  opacity: 1,
                  ...
                  delay: 0.6 + index * 0.1
                      ...
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${getActivityBg(activity.type)}`}>
                        <activity.icon className={`w-5 h-5 ${getActivityColor(activity.type)}`} />
                      </div>
                      <div className="flex-1 min-w-0">
            ...
            delay: 0.7
              ...
              <div className="space-y-6">
                ...
                const maxValue = Math.max(...REVENUE_DATA.map(m => m.total));
                return <div key={month.month} className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
          ...
          <div className="xl:col-span-3">
            ...
            delay: 0.3
              ...
              <div className="space-y-3">
                ...
                <Link to="/admin/users?verificationStatus=unverified" className="w-full flex items-center justify-between px-4 py-3 bg-warm-green text-white rounded-lg hover:bg-warm-green/90 transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5">
                ...
                <Link to="/admin/properties?verificationStatus=unverified" className="w-full flex items-center justify-between px-4 py-3 bg-warm-green text-white rounded-lg hover:bg-warm-green/90 transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5">
                  <div className="flex items-center space-x-3">
                ...
                <button onClick={() => setShowBroadcastModal(true)} className="w-full flex items-center justify-center space-x-3 px-4 py-3 bg-terracotta text-white rounded-lg hover:bg-terracotta/90 transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5">
                  <Bell className="w-5 h-5" />
                  <span className="font-medium">Broadcast Notification</span>
                </button>

                <Link to="/admin/reports" className="w-full flex items-center justify-center space-x-3 px-4 py-3 bg-charcoal text-white rounded-lg hover:bg-charcoal/90 transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5">
              ...
              <div className="mt-8 pt-8 border-t border-charcoal/10">
                ...
                <div className="relative">
                  <svg viewBox="0 0 200 200" className="w-full h-auto">
                    <circle cx="100" cy="100" r="80" fill="none" stroke="#6B6B6B" strokeWidth="20" opacity="0.2" />
                    <motion.circle cx="100" cy="100" r="80" fill="none" stroke="#2D5F3F" strokeWidth="20" strokeDasharray="502.4" initial={{
                    ...
                    <motion.circle cx="100" cy="100" r="80" fill="none" stroke="#D4AF37" strokeWidth="20" strokeDasharray="502.4" initial={{
                    strokeDashoffset: 502.4
                  }} animate={{
                    ...
                    <motion.circle cx="100" cy="100" r="80" fill="none" stroke="#E07A5F" strokeWidth="20" strokeDasharray="502.4" initial={{
                    strokeDashoffset: 502.4
                  }} animate={{
                    ...
                    <text x="100" y="95" textAnchor="middle" className="font-serif text-3xl font-bold fill-charcoal">
                      70%
                    </text>
                    <text x="100" y="115" textAnchor="middle" className="text-xs fill-charcoal/60">
                      Verified
                    </text>
                  </svg>
                </div>
      ...
      <AnimatePresence>
        {showBroadcastModal && <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            <motion.div initial={{
          opacity: 0
        }} animate={{
          opacity: 1
          ...
          opacity: 0
        }} className="absolute inset-0 bg-black/60 backdrop-blur-sm" onClick={() => setShowBroadcastModal(false)} />
            <motion.div initial={{
          opacity: 0,
          scale: 0.95,
          y: 20
          ...
          y: 20
              ...
              <div className="p-6 space-y-6">
                <div>
                  ...
                  <input type="text" value={broadcastTitle} onChange={e => setBroadcastTitle(e.target.value)} placeholder="Enter notification title..." className="w-full px-4 py-3 border border-charcoal/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-terracotta/50 focus:border-terracotta transition-all" />
                </div>
                ...
                <div>
                  ...
                  <textarea value={broadcastMessage} onChange={e => setBroadcastMessage(e.target.value)} placeholder="Enter your message... You can use **bold**, *italic*, and other Markdown formatting." rows={8} className="w-full px-4 py-3 border border-charcoal/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-terracotta/50 focus:border-terracotta transition-all resize-none font-mono text-sm" />
              ...
              <div className="flex items-center justify-end space-x-3 p-6 border-t border-charcoal/10 bg-sand/30">
                <button onClick={() => setShowBroadcastModal(false)} className="px-6 py-3 border border-charcoal/20 text-charcoal rounded-lg hover:bg-charcoal/5 transition-colors font-medium">
                  Cancel
                </button>
                <button onClick={handleBroadcastSend} disabled={!broadcastTitle.trim() || !broadcastMessage.trim()} className="px-6 py-3 bg-terracotta text-white rounded-lg hover:bg-terracotta/90 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed">
                  Send Broadcast
                </button>
              </div>
            </motion.div>
