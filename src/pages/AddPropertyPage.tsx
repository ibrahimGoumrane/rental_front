...
import { Upload, X, ChevronLeft, ChevronRight, Check, Home, MapPin, DollarSign, FileText, Image as ImageIcon, Wifi, Car, Utensils, Tv, Wind, Waves, Building, Castle, Palmtree, ChevronDown, Video, Play, Film, BoxIcon } from 'lucide-react';
const STEPS = [{
  id: 1,
  name: 'Photos & Video',
  icon: ImageIcon
  ...
  return <div className="min-h-screen bg-cream pt-24 pb-12 px-6 md:px-12">
      <div className="max-w-5xl mx-auto">
        ...
        y: 0
          ...
          <button onClick={() => navigate('/landlord/dashboard')} className="flex items-center space-x-2 text-charcoal/60 hover:text-charcoal transition-colors mb-6">
        ...
        <AnimatePresence mode="wait">
          ...
          duration: 0.3
            ...
            {currentStep === 1 && <div>
                ...
                {uploadedImages.length > 0 && uploadedImages.length < 5 && <p className="text-sm text-terracotta mb-8">
                    Please upload at least {5 - uploadedImages.length} more
                    photo(s)
                  </p>}
            ...
            {currentStep === 2 && <div>
                ...
                })} placeholder="e.g., Stunning Villa with Ocean Views" className="w-full px-4 py-3 border border-charcoal/20 rounded-lg outline-none focus:border-warm-green transition-colors" />
                  </div>
                ...
                })} rows={6} placeholder="Describe your space, the neighborhood, and what makes it special..." className="w-full px-4 py-3 border border-charcoal/20 rounded-lg outline-none focus:border-warm-green transition-colors resize-none" />
                  </div>
            ...
            {currentStep === 3 && <div>
                ...
                <div className="space-y-6">
                ...
                })} placeholder="123 Main Street" className="w-full px-4 py-3 border border-charcoal/20 rounded-lg outline-none focus:border-warm-green transition-colors" />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    ...formData,
                    city: e.target.value
                  })} placeholder="San Francisco" className="w-full px-4 py-3 border border-charcoal/20 rounded-lg outline-none focus:border-warm-green transition-colors" />
                    </div>
                  ...
                  })} placeholder="United States" className="w-full px-4 py-3 border border-charcoal/20 rounded-lg outline-none focus:border-warm-green transition-colors" />
                    </div>
                  </div>
            ...
            {currentStep === 4 && <div>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    })} placeholder="120" className="w-full pl-10 pr-4 py-3 border border-charcoal/20 rounded-lg outline-none focus:border-warm-green transition-colors" />
                      </div>
                    ...
                    })} placeholder="50" className="w-full pl-10 pr-4 py-3 border border-charcoal/20 rounded-lg outline-none focus:border-warm-green transition-colors" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="number" min="1" value={formData.minStay} onChange={e => setFormData({
                    ...formData,
                    ...
                    <div>
                      ...
                      <input type="number" min="1" value={formData.maxStay} onChange={e => setFormData({
                    ...formData,
                    maxStay: parseInt(e.target.value)
                  })} className="w-full px-4 py-3 border border-charcoal/20 rounded-lg outline-none focus:border-warm-green transition-colors" />
                    </div>
                  </div>
                </div>
            ...
            {currentStep === 5 && <div>
                ...
                <div className="space-y-8">
                  ...
                  }].map(policy => <label key={policy.value} className={`flex items-start space-x-3 p-4 border-2 rounded-lg cursor-pointer transition-all ${formData.cancellationPolicy === policy.value ? 'border-warm-green bg-warm-green/5' : 'border-charcoal/20 hover:border-charcoal/40'}`}>
                          <input type="radio" name="cancellation" value={policy.value} checked={formData.cancellationPolicy === policy.value} onChange={e => setFormData({
                      ...formData,
