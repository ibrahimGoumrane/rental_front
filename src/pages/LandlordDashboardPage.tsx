...
import { Home, Calendar, DollarSign, TrendingUp, Plus, MessageSquare, Clock, Eye, ArrowRight, Sparkles } from 'lucide-react';
// Mock data
  ...
  return <div className="min-h-screen bg-cream">
      ...
      <section className="pt-24 pb-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Stats Grid */}
          <motion.div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12" initial="hidden" animate="show" variants={{
          hidden: {
            opacity: 0
          },
          show: {
            ...
            show: {
              ...
              <Link to="/landlord/properties" className="block bg-white rounded-2xl p-6 border border-charcoal/5 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all group">
            ...
            show: {
              ...
              <Link to="/landlord/reservations" className="block bg-white rounded-2xl p-6 border border-charcoal/5 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all group">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <p className="text-xs uppercase tracking-widest text-charcoal/60 font-medium mb-2">
                      Reservations
            ...
            show: {
              ...
              <Link to="/landlord/earnings" className="block bg-white rounded-2xl p-6 border border-charcoal/5 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all group">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <p className="text-xs uppercase tracking-widest text-charcoal/60 font-medium mb-2">
                      This Month
            ...
            show: {
              ...
              <Link to="/landlord/reservations?filter=pending" className="block bg-white rounded-2xl p-6 border border-charcoal/5 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all group relative">
                {stats.pendingRequests > 0 && <div className="absolute -top-2 -right-2 w-8 h-8 bg-terracotta text-white rounded-full flex items-center justify-center font-bold text-sm shadow-lg animate-pulse">
      ...
      <section className="py-12 px-6 md:px-12 bg-sand/30">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link to="/landlord/properties" className="flex items-center space-x-2 text-warm-green hover:text-warm-green/80 transition-colors font-medium">
              <span>View all</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            duration: 0.5,
            delay: index * 0.1
          }} onMouseEnter={() => setHoveredProperty(property.id)} onMouseLeave={() => setHoveredProperty(null)} className="group">
                <Link to={`/landlord/properties/${property.id}`} className="block bg-white rounded-2xl overflow-hidden border border-charcoal/5 shadow-sm hover:shadow-xl transition-all hover:-translate-y-2">
                  {/* Image */}
      ...
      <section className="py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link to="/landlord/reservations" className="flex items-center space-x-2 text-warm-green hover:text-warm-green/80 transition-colors font-medium">
              <span>View all</span>
              <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
          ...
          <div className="space-y-4">
            {RECENT_RESERVATIONS.map((reservation, index) => <motion.div key={reservation.id} initial={{
            opacity: 0,
            x: -20
          }} animate={{
            opacity: 1,
            ...
            delay: index * 0.1
                ...
                <Link to={`/landlord/reservations/${reservation.id}`} className="block bg-white rounded-xl p-6 border border-charcoal/5 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all group">
      ...
      <section className="py-12 px-6 md:px-12 bg-sand/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link to="/landlord/properties/new" className="bg-white rounded-2xl p-8 border border-charcoal/5 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group text-center">
            ...
            <Link to="/landlord/earnings" className="bg-white rounded-2xl p-8 border border-charcoal/5 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group text-center">
            ...
            <Link to="/landlord/messages" className="bg-white rounded-2xl p-8 border border-charcoal/5 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group text-center">
