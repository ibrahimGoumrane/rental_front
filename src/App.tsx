...
function AppContent() {
  ...
  return <div className="min-h-screen bg-cream selection:bg-gold/30 selection:text-charcoal">
      ...
      <AnimatePresence mode="wait">
        <Routes>
          ...
          <Route path="/landlord/properties/new" element={<AddPropertyPage />} />
          <Route path="/landlord/properties/:id" element={<LandlordPropertyPreviewPage />} />
          <Route path="/landlord/properties/:id/edit" element={<EditPropertyPage />} />
