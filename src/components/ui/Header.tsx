    ...
    <>
      <header className="sticky top-0 z-50 bg-sand/95 backdrop-blur-md border-b border-charcoal/10 py-4 px-6 md:px-12 shadow-sm">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          {/* Logo */}
          <Link
            to={isLandlordMode ? "/landlord/dashboard" : "/"}
            className="font-serif text-2xl font-bold tracking-tight text-charcoal hover:text-warm-green transition-colors"
          >
            Luxe<span className="text-terracotta">Stay</span>
            {isLandlordMode && (
              <span className="text-gold text-sm ml-2">Host</span>
            )}
          </Link>

          {/* Landlord Navigation */}
          {isLandlordMode && isLoggedIn && (
            <nav className="hidden lg:flex items-center space-x-1">
              <Link
                to="/landlord/dashboard"
                className={`px-4 py-2 rounded-lg transition-colors font-medium text-sm flex items-center space-x-2 ${
                  location.pathname === "/landlord/dashboard"
                    ? "bg-warm-green/10 text-warm-green"
                    : "text-charcoal/70 hover:text-charcoal hover:bg-sand"
                }`}
              >
              ...
              <Link
                ...
                className={`px-4 py-2 rounded-lg transition-colors font-medium text-sm flex items-center space-x-2 relative ${
                  location.pathname === "/landlord/reservations"
                    ? "bg-warm-green/10 text-warm-green"
                    : "text-charcoal/70 hover:text-charcoal hover:bg-sand"
                }`}
              >
                ...
                {landlordStats.pendingRequests > 0 && (
              ...
              <Link
                ...
                className={`px-4 py-2 rounded-lg transition-colors font-medium text-sm flex items-center space-x-2 ${
                  location.pathname === "/landlord/messages"
                    ? "bg-warm-green/10 text-warm-green"
                    : "text-charcoal/70 hover:text-charcoal hover:bg-sand"
                }`}
              >
              ...
              <Link
                ...
                className={`px-4 py-2 rounded-lg transition-colors font-medium text-sm flex items-center space-x-2 ${
                  location.pathname === "/landlord/earnings"
                    ? "bg-warm-green/10 text-warm-green"
                    : "text-charcoal/70 hover:text-charcoal hover:bg-sand"
                }`}
              >
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative" ref={languageMenuRef}>
              <button
                ...
                className="p-2 hover:bg-white/50 rounded-full transition-colors flex items-center space-x-1"
                    ...
                    <div className="p-4 space-y-4">
                        ...
                        <div className="space-y-1">
                          <button
                            ...
                            className={`w-full text-left px-3 py-2 rounded-lg transition-colors ${
                              language === "en"
                                ? "bg-warm-green/10 text-warm-green font-medium"
                      ...
                      <div className="border-t border-charcoal/10 pt-4">
                        ...
                        <select
                          ...
                          className="w-full px-3 py-2 border border-charcoal/20 rounded-lg outline-none focus:border-warm-green transition-colors text-sm"
                        >
            ...
            {!isLoggedIn ? (
              <>
                <Link
                  to="/login"
                  className="hidden md:block px-4 py-2 text-charcoal hover:bg-white/50 rounded-lg transition-colors font-medium text-sm"
                >
                  {t.login}
                </Link>
                <Link
                  to="/signup"
                  className="px-4 py-2 bg-warm-green hover:bg-warm-green/90 text-white rounded-lg transition-colors font-medium text-sm shadow-sm"
                >
                  {t.signup}
                </Link>
              </>
              ...
              <div className="relative" ref={profileMenuRef}>
                <button
                  ...
                  className="flex items-center space-x-3 p-2 pl-4 pr-3 hover:bg-white/50 rounded-full transition-all border border-charcoal/10 group"
                  ...
                  {showProfileMenu && (
                    ...
                    >
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            ...
                            <div className="bg-white rounded-lg p-2 border border-charcoal/10">
                              ...
                              <p className="text-lg font-bold text-gold">
                                $
                                {(landlordStats.monthlyEarnings / 1000).toFixed(
                                  1
                                )}
                                k
                              </p>
                      ...
                      <div className="py-2">
                        <Link
                          to={
                            isLandlordMode ? "/landlord/messages" : "/messages"
                          }
                          onClick={() => setShowProfileMenu(false)}
                          className="flex items-center space-x-3 px-4 py-3 hover:bg-sand transition-colors text-charcoal"
                        >
                        ...
                        <button
                          ...
                          className="flex items-center space-x-3 px-4 py-3 hover:bg-sand transition-colors text-charcoal w-full text-left"
                        >
      ...
      >
        <button
          ...
          className="px-4 py-2 bg-terracotta hover:bg-terracotta/90 text-white rounded-full shadow-2xl text-xs font-bold flex items-center space-x-2 border-2 border-white transition-all hover:scale-105"
        >
          <div
